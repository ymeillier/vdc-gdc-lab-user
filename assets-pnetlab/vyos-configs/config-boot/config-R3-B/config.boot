...
interfaces {
    bridge br113 {
        address 10.130.100.2/24
        address 10.130.107.2/24
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth0 {
        address 10.10.15.113/24
        hw-id 50:3f:6c:00:10:00
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth1 {
        hw-id 50:3f:6c:00:10:01
        mtu 8896
    }
    ethernet eth2 {
        address 5.0.8.2/30
        address fd:0:0:508::2222/64
        hw-id 50:3f:6c:00:10:02
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth3 {
        address 6.0.8.2/30
        address fd:0:0:608::2222/64
        hw-id 50:3f:6c:00:10:03
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth4 {
        hw-id 50:3f:6c:00:10:04
        mtu 8846
    }
    ethernet eth5 {
        disable
        hw-id 50:3f:6c:00:10:05
        ipv6 {
            address {
            }
        }

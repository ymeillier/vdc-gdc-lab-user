...
interfaces {
    ethernet eth0 {
        address 10.10.15.115/24
        hw-id 50:01:b6:00:0e:00
        ipv6 {
            address {
    ...
    ethernet eth1 {
        address 6.0.1.1/30
        address fd:0:0:601::1111/64
        hw-id 50:01:b6:00:0e:01
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth2 {
        address 6.0.2.1/30
        address fd:0:0:602::1111/64
        disable
        hw-id 50:01:b6:00:0e:02
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth3 {
        address 6.0.3.1/30
        address fd:0:0:603::1111/64
        hw-id 50:01:b6:00:0e:03
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth4 {
        address 6.0.4.1/30
        address fd:0:0:604::1111/64
        disable
        hw-id 50:01:b6:00:0e:04
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth5 {
        address 6.0.5.1/30
        address fd:0:0:605::1111/64
        hw-id 50:01:b6:00:0e:05
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth6 {
        address 6.0.6.1/30
        address fd:0:0:606::1111/64
        disable
        hw-id 50:01:b6:00:0e:06
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth7 {
        address 6.0.7.1/30
        address fd:0:0:607::1111/64
        disable
        hw-id 50:01:b6:00:0e:07
        ipv6 {
            address {
            }
        }
    ...
    ethernet eth8 {
        address 6.0.8.1/30
        address fd:0:0:608::1111/64
        hw-id 50:01:b6:00:0e:08
        ipv6 {
            address {
            }
        }
    ...
    loopback lo {
        address 10.0.140.2/32
        address fd:0:0:140::2222/64
    }
}
policy {
...
protocols {
    bgp {
        ...
        neighbor 6.0.8.2 {
            ...
            update-source 6.0.8.1
        }
        parameters {
            router-id 10.0.140.2
        }
        peer-group dyn-peers-r0 {
            address-family {
                ipv4-unicast {
